...
import { useAuth } from '../contexts/AuthContext'; // Simple import
  ...
  return (
    <nav className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-3 shadow-md sticky top-0 z-10">
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="text-lg font-semibold hover:opacity-80 tracking-tight flex items-center space-x-2">
           <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-label="Navigation marker icon">
